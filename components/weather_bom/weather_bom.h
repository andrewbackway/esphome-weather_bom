...
class WeatherBOM : public PollingComponent {
 public:
  ...
  void set_today_sunrise_sensor(text_sensor::TextSensor* s) {
    today_sunrise_ = s;
  }
  void set_today_sunset_sensor(text_sensor::TextSensor* s) {
    today_sunset_ = s;
  }
  ...
  void set_tomorrow_sunrise_sensor(text_sensor::TextSensor* s) {
    tomorrow_sunrise_ = s;
  }
  void set_tomorrow_sunset_sensor(text_sensor::TextSensor* s) {
    tomorrow_sunset_ = s;
  }
